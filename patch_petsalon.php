<?php
$file = '/Users/ahmadmukhtar/Projects/rpc-be/app/Http/Controllers/Transaction/PetSalonController.php';
$content = file_get_contents($file);

$startCheckPromo = '    public function checkPromo(Request $request)';
$startTransDisc = '    public function transactionDiscount(Request $request)';
$startPayment = '    public function payment(Request $request)';

$posCheckPromo = strpos($content, $startCheckPromo);
$posTransDisc = strpos($content, $startTransDisc);
$posPayment = strpos($content, $startPayment);

if ($posCheckPromo === false || $posTransDisc === false || $posPayment === false) {
    echo "Markers not found\n";
    exit(1);
}

$replacementCheckPromo = <<<'REPLACE'
...
$part1 = substr($content, 0, $posCheckPromo);
$part2 = substr($content, $posPayment);

$newContent = $part1 . $replacementCheckPromo . "\n" . $replacementTransDisc . "\n" . $part2;

file_put_contents($file, $newContent);
echo "Successfully patched checkPromo and transactionDiscount\n";
?>
