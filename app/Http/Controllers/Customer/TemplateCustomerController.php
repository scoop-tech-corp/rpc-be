...
class TemplateCustomerController extends Controller
{
    ...
    function download()
    {
        ...
        $newFilePath = public_path() . '/template_download/' . 'Template Upload Customer.xlsx'; // Set the desired path
        ...
        return response()->stream(function () use ($writer) {
            ...
            'Content-Disposition' => 'attachment; filename="Template Upload Customer.xlsx"',
        ]);
    }
}
