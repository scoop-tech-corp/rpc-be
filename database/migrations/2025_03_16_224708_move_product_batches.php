...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::dropIfExists('productSellBatches');
        Schema::dropIfExists('productClinicBatches');
    }
    ...
    {
        Schema::create('productSellBatches', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('productClinicBatches', function (Blueprint $table) {
            $table->id();
