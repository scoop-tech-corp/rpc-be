    ...
    public function run()
    {
        ...
        for ($j = 1; $j <= 30; $j++) {
            ...
            DB::table('location_messenger')
                ->insert(['codeLocation' => $code, "messengerNumber" => $faker->phoneNumber, "type" => $faker->randomElement(['Office', 'Fax']), "usage" =>  $isPrimaryMessenger, "isDeleted" => 0, 'created_at' => now(), 'updated_at' => now(), ]);
        ...
        for ($j = 1; $j <= 30; $j++) {
            ...
            $phone = [
                ['codeLocation' => $code, "phoneNumber" => $faker->phoneNumber, "type" => $faker->randomElement(['Telepon Selular', 'Whatshapp']), "usage" =>  "Utama", "isDeleted" => 0, 'created_at' => now(), 'updated_at' => now(), ],
                ['codeLocation' => $code, "phoneNumber" => $faker->phoneNumber, "type" => $faker->randomElement(['Telepon Selular', 'Whatshapp']), "usage" =>  "Secondary", "isDeleted" => 0, 'created_at' => now(), 'updated_at' => now(), ]
            ];
